  ...
  return (
    ...
    >
      ...
      <div className="flex flex-col items-center gap-8 mb-16">
        <ScrollFloat
          containerClassName="font-display text-5xl sm:text-6xl text-[#FADAD8] drop-shadow-md text-center z-10 relative"
        >
          Mesa de Regalos
        </ScrollFloat>
      ...
      >
        ...
        <p className="text-[#FADAD8]/90 text-base md:text-lg leading-relaxed mb-4 font-light max-w-sm">
          Tu presencia es nuestro regalo más valioso.
        </p>
        <p className="text-[#FADAD8]/80 text-sm md:text-base leading-relaxed font-light max-w-sm mb-4">
          Si deseas tener un detalle adicional con{' '}
          <strong className="font-normal text-[#FADAD8]">Emma Lucía</strong>,
