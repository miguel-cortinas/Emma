  ...
  return (
    ...
    >
      ...
      <div className="relative z-10 flex flex-col items-center text-center max-w-2xl">
        ...
        {/* Título */}
        <h2
          className="fairy-text leading-none mb-6 font-display text-[clamp(3.5rem,12vw,7rem)] text-dusty-400"
          style={{
        ...
        <p className="fairy-text text-dusty-100/90 text-lg md:text-xl font-light tracking-wide max-w-md mx-auto mb-12 drop-shadow-[0_2px_10px_rgba(139,106,114,0.5)]">
          ...
          <span className="font-semibold text-dusty-400">Emma Lucía</span>.
        </p>
        ...
        <div className="fairy-text">
          <MagneticButton>
            <a
              ...
              className="group relative inline-flex items-center justify-center px-10 py-5 text-sm font-medium text-dusty-400 transition-all duration-700 rounded-[2rem] overflow-hidden backdrop-blur-md"
              style={{
            ...
            >
              ...
              <span className="relative flex items-center gap-3 tracking-[0.15em]">
                ...
                <svg
                  viewBox="0 0 24 24"
                  className="w-5 h-5 fill-current text-dusty-200 group-hover:text-dusty-400 transition-colors duration-500"
